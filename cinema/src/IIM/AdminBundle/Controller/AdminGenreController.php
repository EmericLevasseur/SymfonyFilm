...
use IIM\CinemaBundle\Entity\Genre;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Symfony\Component\HttpFoundation\Request;
use IIM\AdminBundle\Form\GenreType;
...
class AdminGenreController extends Controller
{
    ...
    */
    public function addAction(Request $request)
    {
        ...
        return $this->render(
            'IIMAdminBundle:Genre:form.html.twig',
    ...
    */
    ...
    {
      $genres = $this->getDoctrine()->getRepository('IIMCinemaBundle:Genre')->findAll();

      return $this->render(
          'IIMAdminBundle:Genre:list.html.twig',
          ['genres' => $genres]
        );
      }
    ...
    */
    public function editAction(Request $request, $id)
    {
      ...
      $genre = $this->getDoctrine()->getRepository('IIMCinemaBundle:Genre')->find($id);
