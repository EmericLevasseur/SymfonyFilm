...
// src/IIM/AdminBundle/Controller/AdminPersonneController.php
namespace IIM\AdminBundle\Controller;

use IIM\CinemaBundle\Entity\Personne;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Symfony\Component\HttpFoundation\Request;
use IIM\AdminBundle\Form\PersonneType;
/**
...
class AdminPersonneController extends Controller
{
    ...
    */
    public function addAction()
    {
      ...
      return $this->render(
          'IIMAdminBundle:Personne:form.html.twig',
    ...
    */
    public function listAction()
    {
      ...
      return $this->render(
        'IIMAdminBundle:Personne:list.html.twig',
